...
export default function CompanyCreateAccountPage() {
  ...
  useEffect(() => {
    trackEmployerTypeSelected('company');
  }, []);
  ...
  function handleFormFocus() {
    if (!formStarted) {
      setFormStarted(true);
      trackEmployerFormStarted('company');
    }
  }
  ...
  return (
    <main>
      <header>
        ...
        <p>Enter your credentials to create an employer account for your company.</p>
      </header>
